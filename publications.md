...
<br>JOURNAL: Applied Soft Computing,**JCR Q1**  
<br>**First author**  
...
### Learning Effectiveness Analysis for Data Mining Course Based on Structural Equation Modeling (Published)
<br>JOURNAL: Guide Magazine, Sep.2023
<br>**First author**
- Collected data on students’ learning situation in the data mining course, and applied factor analysis to prove the good validity of the questionnaire structure.
- Utilized structural equation modeling to obtain the impact of students’ pre-class foundation, in-class status, and post-class expansion on learning outcomes, ultimately provided suggestions for students’ learning and teachers’ teaching.
